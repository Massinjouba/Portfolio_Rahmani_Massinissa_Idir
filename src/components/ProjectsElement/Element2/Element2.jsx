  ...
  return (
    <div className="element2-container">
      <div className='header-content'>
        ...
        <a href="https://github.com/Massinjouba/GesMedecin" target="_blank" rel="noopener noreferrer" className='buton'>
            See on GitHub
        </a>
      </div>
      <div className="element2-content">
        ...
        <div className="element2-image">
          <img src="src\assets\images\Projet 2.png" alt="Project" />
          <img src="src\assets\images\Projet 2,2.png" alt="Project" />
          <img src="src\assets\images\Projet 2,3.png" alt="Project" />
        </div>
      </div>
    </div>
  );
