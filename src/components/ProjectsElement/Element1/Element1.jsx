  ...
  return (
    <div className="element1-container">
      <div className='header-content'>
        ...
        <a href="https://github.com/idir-kebbiche/GestionCanabis" target="_blank" rel="noopener noreferrer" className='buton'>
            See on GitHub
        </a>
      </div>
      <div className="element1-content">
        ...
        <div className="element1-image">
          <img src="src\assets\images\Projet 1,3.png" alt="Project" />
          <img src="src\assets\images\Projet 1.png" alt="Project" />
          <img src="src\assets\images\Projet 1,2.png" alt="Project" />
        </div>
      </div>
    </div>
  );
